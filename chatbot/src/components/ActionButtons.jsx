    ...
    <div className="w-[450px] bg-[#d3eaff] ">
      ...
      <div className="pb-5 bg-[#d3eaff]">
        <div class="grid grid-cols-3 gap-4 bg-[#D3EAFF] pl-5">
          <button className="w-24 pl-2 bg-[#052F44] border-none rounded-md items-center">
            <img src={parking} className="w-20"></img>
            <p className="text-[#FFD700] font-thin">Parking</p>
          </button>
          <button className="w-24 bg-[#052F44] border-none rounded-md">
          ...
          <button className="w-24 py-1 bg-[#052F44] border-none rounded-md">
